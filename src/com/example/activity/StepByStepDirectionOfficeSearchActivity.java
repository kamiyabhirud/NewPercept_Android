...
public class StepByStepDirectionOfficeSearchActivity extends ListActivity {

	public ArrayList<HashMap<String, String>> selectedroutedetails=  ListOfRoutesActivity.tempselectedroutedetails ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.stepbystepdirectionofficesearchlayout);
		  ...
		  Button buttonok = (Button) findViewById(R.id.button_backroutelistofc);
			buttonok.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					Intent gotoregisterpage = new Intent(StepByStepDirectionOfficeSearchActivity.this, ResultSearchByOfficeNameActivity.class);
	        ...
	        protected void onPostExecute(Void result) {
	            ...
	            try{
	            	  ...
	            	  ListAdapter stepsadapter = new SimpleAdapter(
	            			  StepByStepDirectionOfficeSearchActivity.this, routestepslist,
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.step_by_step_direction_office_search,
				menu);
		return true;
	}
