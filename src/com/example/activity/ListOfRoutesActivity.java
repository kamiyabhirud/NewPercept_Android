...
public class ListOfRoutesActivity extends ListActivity {

private static String API_KEY ="AIzaSyCauDrsTQ-6j6cAEothtNZD7P1kBUUaH6Y";
	/********** result from search by office name*******/
	public String toencodeorigin = ResultSearchByOfficeNameActivity.tempgetsource ;
	private String origin = "origin=" + 	encodeforurl(toencodeorigin);
	
	private String toencodedestination = ResultSearchByOfficeNameActivity.tempgetdestination;
	...
	// JSON Node names
		...
		public static LatLng sourcelatlngofcname ;
		public static LatLng destinationlatlngofcname;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listofrouteslayout);
...
//				
				   ...
				   Intent gotodirectionspage = new Intent(ListOfRoutesActivity.this,MapsRouteActivity.class);     
	...
	private class Getroutelist extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(GetDirectionsActivity.this);
			pDialog.setMessage("Please wait...");
			pDialog.setCancelable(false);
			pDialog.show();

		} */// on pre execute ends here
...
//							System.out.println("jobjlegs------------>>>>>>"+jobjlegs);	
							...
							double sourcestartlng = jobjstartloc.getDouble(TAG_LNG);
							 sourcelatlngofcname = new LatLng(sourcestartlat,sourcestartlng);
							...
							double destendlng = jobjendloc.getDouble(TAG_LNG);
							 destinationlatlngofcname = new LatLng(destendlat,destendlng);
...
//							System.out.println("rduration : "+ rduration );
	     ...
	     //       System.out.println("Err in onpost exeute----------------->");
	         ...
	         // ListAdapter routelistadapter = new SimpleAdapter(
	            //        GetDirectionsActivity.this, routeslist, R.layout.selectroute, from,to );  
//	            	   ArrayAdapter<HashMap<String, String>> routelistadapter = new ArrayAdapter<HashMap<String, String>>(
//	            			   ListOfRoutesActivity.this, android.R.layout.simple_list_item_1,android.R.id.text1, routeslist );
	            	   
	            	  ListAdapter adapter = new SimpleAdapter(
	            			  ListOfRoutesActivity.this, routeslist,
